...
public class BluetoothChannel {
    ...
    public static final int STATE_STARTED = 1;    // start() was called, but no connection.
     ...
     */
    public BluetoothChannel(Context context, Handler handler) {
